...
BOT_USERNAME = getenv("BOT_USERNAME" , "SanataniiMusicBot")
BOT_NAME = getenv("BOT_NAME" , "SanataniiMusicBot")
ASSUSERNAME = getenv("ASSUSERNAME" , "SANATANI_ASSISTANT")
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
LOGGER_ID = int(getenv("LOGGER_ID", -1007464970018))
OWNER_ID = int(getenv("OWNER_ID", 7883634874))
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Prin718/RADHEXMUSIC07",)
